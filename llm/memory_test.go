...
func (p *MockProvider) HasCapability(cap llmx.CapabilityType, model ...string) bool { return false }
...
func (l *MockLLM) SupportsStreaming() bool {
	return l.provider.HasCapability(llmx.CapabilityType_CAPABILITY_TYPE_STREAMING)
}
